...
public class GoalsActivity extends AppCompatActivity {
    ...
    // functions to compare and check dates (if its the same day or if its in the day)
        ...
        adapter.setOnGoalChangeListener(new GoalAdapter.OnGoalChangeListener() {
            ...
            public void onGoalUpdated(Goal goal, GoalInstance goalInstance) {
                ...
                goalsViewModel.getGoal(goalId, parentGoal -> {
                    if (parentGoal != null) {
                        ...
                        // ensure that goal instances are only deleted if start/end dates are changed
                        // delete and recreate so that there are no conflicts
                        // e.g. end on 28/4 but goal instance still existing on 29/4
            ...
            public void onGoalDeleted(Goal goal, GoalInstance goalInstance, Boolean deleteAllGoalInstances, String date) {
                if (deleteAllGoalInstances) {
                    ...
                    // delete all goal instances of that goal
    ...
    private void ScrollableRow(Calendar startDate) {
        ...
        // idea generated by AI, code written by Kiah Yen
        // used to ensure that all 7 buttons are displayed on the screen with equal width
        dateBar.post(() -> {
            ...
            if (parentWidth > 0) {
                ...
                for (int i = 0; i < 7; i++) {
                    ...
                    // creating and styling date buttons
                    ...
                    // changing height of each button to match Figma prototype
                    int heightInDp = 70;
    ...
    // for highlighting date buttons in header
    ...
    // all the functions for sorting goals
